...
const ImpactCard: React.FC<ImpactCardProps> = ({ category, outcome, context, icon, gradient }) => (
  <div className="bg-white dark:bg-slate-900 rounded-2xl p-8 pb-10 border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between h-full min-h-[320px] relative overflow-hidden group">
